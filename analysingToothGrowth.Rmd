...
The confidence intervals of the different doses are not overlapping indicating an possitive effect of dose on odentoblast length. The confidence intervals of the supplement types are overlapping indicating no (clear) separation between the different supplement types.
